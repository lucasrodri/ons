 ...
 * @author lucas
 */
public class MBM_SR implements RA {
    ...
    private int maxRateM1;
    private int maxRateM2;
    private int maxRateM3;
    private int maxRateM4;
    ...
    public void simulationInterface(ControlPlaneForRA cp) {
        ...
        this.maxRateM1 = Modulation.convertSlotToRate(((EONOXC) cp.getPT().getNode(0)).getCapacity(), EONPhysicalTopology.getSlotSize(), 0);
        this.maxRateM2 = Modulation.convertSlotToRate(((EONOXC) cp.getPT().getNode(0)).getCapacity(), EONPhysicalTopology.getSlotSize(), 1);
        this.maxRateM3 = Modulation.convertSlotToRate(((EONOXC) cp.getPT().getNode(0)).getCapacity(), EONPhysicalTopology.getSlotSize(), 2);
        this.maxRateM4 = Modulation.convertSlotToRate(((EONOXC) cp.getPT().getNode(0)).getCapacity(), EONPhysicalTopology.getSlotSize(), 3);
    }
    ...
    public void flowArrival(Flow flow) {
        ...
        for (int k = 0; k < kpaths.length; k++) {
            ...
            int requiredSlots = ((EONOXC)cp.getPT().getNode(0)).getCapacity();
            int[] firstSlot;
    ...
    private int maxRate(int modulation) {
        switch (modulation) {
                case 0: return this.maxRateM1;    
                case 1: return this.maxRateM2;    
                case 2: return this.maxRateM3;
                case 3: return this.maxRateM4;
                default: return this.maxRateM1;
        }
    }
}
