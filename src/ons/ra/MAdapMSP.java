 ...
 * @author lucas
 */
public class MAdapMSP implements RA {
    ...
    public void flowArrival(Flow flow) {
        ...
        int modulation = EONPhysicalTopology.getMaxModulation(), modulation_aux;
        int[] spectrum;
        int requiredSlots;
        ...
        while (true) {
            ...
            spectrum = arrayListToArrayInt(S[flow.getDestination()]);
     ...
     * @return 
     */
    private TreeSet<Integer> Psi(ArrayList<Integer>[] S, int j, int k, int requiredSlots) {
