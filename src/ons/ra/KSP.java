...
/**
 * The proposed Xin Wan. Article: "Dynamic routing and spectrum assignment in
 * spectrum flexible transparent optical networks", Xin Wan, Nan Hua, and
 * Xiaoping Zheng, Optical Communications and Networking, IEEE/OSA Journal of,
 * Aug 2012.
 *
 * @author lucas
 */
        ...
        */
        ...
        for (int k = 0; k < kpaths.length; k++) {
            ...
            for (int i = 0; i < links.length; i++) {
                largestLinkKM = largestLinkKM + cp.getPT().getLink(links[i]).getWeight();
            }
